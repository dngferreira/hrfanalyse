...
This modules obejctive is to study the block's in a file os files in a
...
applicationaly speaking this would also work for an entropy dictionary.
...
This module's entry point funcion is apply_metric(...)
"""
import numpy
import csv
import logging
